  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8 lg:py-12">
          <div className="text-center">
            ...
            >
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                令和7年度 国家予算可視化
              </h1>
            </motion.div>
            <motion.p 
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
        ...
        >
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-600 mb-1">歳入総額</p>
                <p className="text-2xl lg:text-3xl font-bold text-gray-800">{formatCurrency(revenueTotal)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-600 mb-1">歳出総額</p>
                <p className="text-2xl lg:text-3xl font-bold text-gray-800">{formatCurrency(expenditureTotal)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-600 mb-1">収支差額</p>
                <p className={`text-2xl lg:text-3xl font-bold ${revenueTotal - expenditureTotal >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        {/* Instructions */}
        <motion.div 
          className="mt-16 lg:mt-20 bg-white/60 backdrop-blur-sm rounded-3xl p-10 lg:p-12 border border-gray-200/50"
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2 text-lg">クリックで詳細表示</h4>
                <p className="text-gray-600 leading-relaxed">円グラフのセグメントをクリックすると、より詳細な内訳を確認できます</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2 text-lg">ホバーで金額確認</h4>
                <p className="text-gray-600 leading-relaxed">セグメントにマウスを重ねると、具体的な金額がツールチップで表示されます</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2 text-lg">パンくずで階層移動</h4>
                <p className="text-gray-600 leading-relaxed">「戻る」ボタンやパンくずナビゲーションで上位階層に戻ることができます</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      {/* Footer */}
      <motion.footer 
        className="mt-20 lg:mt-24 bg-white/50 backdrop-blur-sm border-t border-gray-200/50"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
